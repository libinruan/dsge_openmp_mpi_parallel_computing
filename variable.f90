module variable
    ...
    real(wp) :: para(129), & ! total number of parameters in _lparameter.txt excluding boolin variables (printout1, etc).
                ...
                phi3 = 0.97, & ! Set 
                beta = 0.93, & ! on annual basis.
                zbar = 2.0, & ! to be calibrated # 2.374. could bring the labor employment positive in both sectors 1.8
